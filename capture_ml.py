...
def telegram_send(fig=None, text=None, key='8884910787382816523'):
	global tp
...
def classify():
    ...
    for i, probs in enumerate(res):
        ...
        for id in top_ind:
            det_label = labels_map[str(id)][1] if labels_map else "{}".format(id)
            ...
            print("{}{}\t{}{}{:.7f}".format(' ' * space_num_before, det_label,
                                          ...
                                          probs[id]))
        print("\n")
    #telegram_send(text="%s with p: %f"%(labels_map[str(0)][1], probs[0]))
